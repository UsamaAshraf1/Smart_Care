...
import { Calendar, Clock, MapPin, Phone, Award, GraduationCap, Briefcase, Star } from "lucide-react"
...
export default function DoctorPage({ params }: DoctorPageProps) {
  ...
  const doctors = {
    "sarah-johnson": {
      ...
      specialties: ["Preventive Cardiology", "Heart Failure Management", "Cardiac Rehabilitation", "Echocardiography"],
      certifications: [
    ...
    "emily-rodriguez": {
      ...
      specialties: ["Well-Child Care", "Developmental Pediatrics", "Behavioral Health", "Adolescent Medicine"],
      certifications: [
  ...
  const doctor = doctors[params.id as keyof typeof doctors] || {
    ...
    <div className="flex flex-col min-h-screen">
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_500px]">
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl">{doctor.name}</h1>
                <p className="text-xl text-muted-foreground">{doctor.title}</p>
        ...
        <div className="container px-4 md:px-6">
          <Tabs defaultValue={activeTab} className="w-full">
            ...
            <TabsContent value="education" className="mt-6">
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-lg font-bold mb-4">Education & Training</h3>
            ...
            <TabsContent value="specialties" className="mt-6">
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-lg font-bold mb-4">Clinical Specialties</h3>
                  <div className="grid gap-2 md:grid-cols-2">
                    {doctor.specialties.map((specialty, index) => (
                      <div key={index} className="flex items-center space-x-2 p-2 rounded-md bg-primary/5">
                        <span>{specialty}</span>
                      </div>
                    ))}
                  </div>
            ...
            <TabsContent value="booking" className="mt-6">
              <Card>
                ...
                <CardContent className="p-6">
                  <BookingWidget doctorId={params.id} doctorName={doctor.name} />
                </CardContent>
              </Card>
            </TabsContent>
          </Tabs>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-primary/5">
        <div className="container px-4 md:px-6 text-center">
          <h2 className="text-3xl font-bold tracking-tighter mb-4">Schedule an Appointment</h2>
